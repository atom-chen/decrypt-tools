...
#
# https://github.com/bigkan/decrypt-xuezu
# https://blog.csdn.net/sectown/article/details/79473617
#
...
def decrypt_xuezu(filedir,outdirpath):
    pngnum = 0
    jpgnum = 0
    luanum = 0
    csvnum = 0
...
if __name__ == '__main__':
    ...
    decrypt_xuezu(filedir, outdirpath)
